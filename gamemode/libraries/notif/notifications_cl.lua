...
net.Receive("nx.notif.conprint", function()
	...
	printColorized(color_white, "![nx] ", Color(200, 200, 200), decodeHelper())
end)

net.Receive("nx.notif.chat", function()
	chat.AddText(color_white, decodeHelper())
end)

net.Receive("nx.notif.chatprint", function()
...
net.Receive("nx.notif.screenCenter", function()
